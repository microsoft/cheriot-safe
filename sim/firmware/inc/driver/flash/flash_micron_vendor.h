...
#ifndef __FLASH_MICRON_VENDOR_H__
#define __FLASH_MICRON_VENDOR_H__

class Flash_Micron_Vendor : public Flash_Base_Vendor
{
  public:

   Flash_Micron_Vendor() : Flash_Base_Vendor()
   {
     // printf("\nMicron Vendor\n");
   }
 ...
 */
FLASH_CMDS_t Flash_Micron_Vendor::get_Read_cmd()
{
 ...
 */
FLASH_CMDS_t Flash_Micron_Vendor::get_Write_cmd()
{
...
FLASH_CMDS_t Flash_Micron_Vendor::get_ReadFlagSR_cmd()
{
  return FLASH_CMD_READ_FLAG_STATUS_REGISTER;
}


FLASH_CMDS_t Flash_Micron_Vendor::get_ReadID_cmd()
{
  if(m_mode != FLASH_ESPI_MODE) return FLASH_CMD_READ_ID_MULTI_IO;
  else return FLASH_CMD_READ_ID;
}
