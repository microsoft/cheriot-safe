...
// getLock
//========================================================
extern "C" void getLock(unsigned long *addr) {
    return;
}
...
// releaseLock
//========================================================
extern "C" void releaseLock(unsigned long *addr) {
    return;
}
...
// Write 
//========================================================
extern "C" int _write(int fd, const char* data, int size) {
